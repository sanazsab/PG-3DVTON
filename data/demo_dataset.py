...
class DemoDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        source_img_path = os.path.join('/local_storage/users/sanazsab/dataset/images', source_splitext + '.jpg')
        cloth_parse_path = os.path.join('/local_storage/users/sanazsab/dataset/cloth_mask', cloth_splitext + '_mask.png')
        
        if self.opt.warp_cloth:
            cloth_img_path = os.path.join('/local_storage/users/sanazsab/dataset/images', cloth_img)
        else:
            cloth_img_path = os.path.join('/local_storage/users/sanazsab/dataset/cloth_image', cloth_img)
        ...
        source_parse_vis_path = os.path.join('/local_storage/users/sanazsab/dataset/parse_cihp', source_splitext + '_vis.png')
        source_parse_vis = self.transforms['3'](Image.open(source_parse_vis_path))        
        source_parse_path = os.path.join('/local_storage/users/sanazsab/dataset/parse_cihp', source_splitext + '.png')
        ...
        source_pose_path = os.path.join('/local_storage/users/sanazsab/dataset/pose_coco', source_splitext +'_keypoints.json')
        ...
        if self.opt.warp_cloth:
            ...
            target_pose_path = os.path.join('/local_storage/users/sanazsab/dataset/pose_coco', data_suffix, target_splitext.split('/')[1] +'_keypoints.json')
            ...
            target_pose_path = os.path.join('/local_storage/users/sanazsab/dataset/pose_coco', target_pose)
