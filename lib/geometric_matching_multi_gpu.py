...
class GMM(nn.Module):
    ...
    """
    def __init__(self, input1_nc, input2_nc, opt):
        super(GMM, self).__init__()
        self.extractionA = FeatureExtraction(input1_nc, ngf=64, n_layers=3, norm_layer=nn.BatchNorm2d) 
        self.extractionB = FeatureExtraction(input2_nc, ngf=64, n_layers=3, norm_layer=nn.BatchNorm2d)
